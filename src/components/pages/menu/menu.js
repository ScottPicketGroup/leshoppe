...
const Menu = ({ menuOpen, setMenuOpen, menuImage }) => {
      ...
      <PopOuBackground display={menuOpen}>
        <MenuContainer display={menuOpen}>
          <MenuHeader>
            ...
            >
              <SVG
                ...
                viewBox="0 0 19.085 19.085"
                style={{ marginRight: `1.5rem` }}
              >
                <path
                  id="Path_11769"
                  data-name="Path 11769"
                  d="M2807.2-13381l18.025,18.024"
                  transform="translate(-2806.668 13381.53)"
                  fill="none"
                  strokeWidth="1.5"
                />
                <path
                  ...
                  d="M2807.2-13381l18.025,18.024"
                  transform="translate(-13362.445 -2806.668) rotate(90)"
                  fill="none"
                  strokeWidth="1.5"
                />
              </SVG>
          ...
          <MenuLinksContainer>
            ...
            <ImgBox>
              <MenuLandscape menuImage={menuImage}/>
            </ImgBox>
            <Socials>
              <Facebook menu />
              <Instagram menu />
...
export const PopOuBackground = styled.div`
  ...
  transform: ${props =>
    props.display ? "translateX(0vh)" : "translateX(100vw)"};
...
export const MenuContainer = styled.div`
  ...
  transition: right 0.275s ease-out;
